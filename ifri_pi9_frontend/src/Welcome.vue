                ...
                <ul v-if="offers.length">
                    <li v-for="offer in offers" :key="offer.id" class="offer-card">
                        <div>
                            ...
                            <span class="date"><i class="fa fa-calendar"></i> {{ offer.date }}</span>
                        </div>
                        <div>
                            <span class="driver"><i class="fa fa-user"></i> {{ offer.driver }}</span>
                            <span class="seats"><i class="fa fa-chair"></i> {{ offer.seats }} places</span>
                        </div>
                    </li>
                </ul>
